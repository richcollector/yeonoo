...
public class CompanyRestController {
	...
	public HashMap<String, Object> departmentInfo(Model model, String searchType, String searchWord, String company_code,
									@RequestParam(value="pageNum", defaultValue = "1") int pageNum) {
		
		HashMap<String, Object> map = new HashMap<String, Object>();
		
		ArrayList<DepartmentVo> departmentList = companyService.departmentInfo(searchType, searchWord, pageNum, company_code);
		
		int orderCount = companyService.departmentInfoCount(searchType, searchWord, company_code);
...
//		model.addAttribute("accountList", accountList);
	...
	public HashMap<String, Object> employeeRankInfo(Model model, String searchType, String searchWord, String company_code,
									@RequestParam(value="pageNum", defaultValue = "1") int pageNum) {
		
		HashMap<String, Object> map = new HashMap<String, Object>();
		
		ArrayList<EmployeeRankVo> employeeRankList = companyService.employeeRankInfo(searchType, searchWord, pageNum, company_code);
		
		int orderCount = companyService.employeeRankInfoCount(searchType, searchWord, company_code);
