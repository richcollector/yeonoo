...
public class ObtainOrderVo {
	...
	public ObtainOrderVo() {
		super();
	}

	public ObtainOrderVo(String obtain_order_code, String company_code, String account_code, String obtain_order_state,
			String obtain_order_manager, Date obtain_order_date, Date obtain_order_due_date,
