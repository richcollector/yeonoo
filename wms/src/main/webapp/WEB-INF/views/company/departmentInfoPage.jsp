...
// 					inA3.setAttribute("href","./accountInfo?pageNum="+startPage+-1+additionalParam);
		...
		xhr.open("get", "../company/departmentInfo?searchType=" + clickSearchTypeVal + "&searchWord=" + clickSearchWordVal);	//리퀘스트 세팅..
		//xhr.setRequestHeader("Content-type","application/x-www-form-urlencoded");	//post
...
// 					inA3.setAttribute("href","./accountInfo?pageNum="+startPage+-1+additionalParam);
		...
		xhr.open("get", "../company/departmentInfo?pageNum="+ pageNumVal +"&searchType=" + clickSearchTypeVal + "&searchWord=" + clickSearchWordVal);	//리퀘스트 세팅..
		//xhr.setRequestHeader("Content-type","application/x-www-form-urlencoded");	//post
		xhr.send();	//AJAX로 리퀘스트함...
