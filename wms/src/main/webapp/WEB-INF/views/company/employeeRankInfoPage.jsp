...
<script type="text/javascript">
	...
	function insertEmployeeRankInfo(){
		
		var company_code = document.getElementById("company_code_reg").value;
		var employee_rank_name = document.getElementById("employee_rank_name_reg").value;
		...
		xhr.open("post" , "./EmployeeRankRegisterProcess");
		xhr.setRequestHeader("Content-type","application/x-www-form-urlencoded");
		xhr.send("company_code=" + company_code + "&employee_rank_name=" + employee_rank_name);	
	...
	function selectAccount(){
		...
		var employee_rank_code = checkVal;
		var company_code_update = document.getElementById("company_code_update");
		var employee_rank_name_update = document.getElementById("employee_rank_name_update");
		...
		xhr.onreadystatechange = function(){
			if(xhr.readyState == 4 && xhr.status == 200){
				...
				employee_rank_name_update.value = jsonObj.data.employee_rank_name;
		...
		xhr.open("post", "./selectEmployeeRankInfo");	//리퀘스트 세팅..
		xhr.setRequestHeader("Content-type","application/x-www-form-urlencoded");	//post
		xhr.send("company_code=" + company_code + "&employee_rank_code=" + employee_rank_code);	//AJAX로 리퀘스트함...
	...
	function updateEmployeeRankInfo(){
		...
		var employee_rank_name = document.getElementById("employee_rank_name_update").value;
		...
		xhr.setRequestHeader("Content-type","application/x-www-form-urlencoded");
		xhr.send("company_code=" + company_code + "&employee_rank_code=" + employee_rank_code_update + "&employee_rank_name=" + employee_rank_name);		
		refreshAccountInfo();
		
	}
	
	function deleteEmployeeRankInfo(){
		...
		xhr.open("post" , "./deleteEmployeeRankInfo" , false);
		xhr.setRequestHeader("Content-type","application/x-www-form-urlencoded");
...
//  		tableDiv.innerHtml = "";
		...
		xhr.onreadystatechange = function(){
			if(xhr.readyState == 4 && xhr.status == 200){
				...
				for(commentData of jsonObj.employeeRankList){
...
// 				tbody1.innerHtml = "";
				...
				inputIn1.setAttribute("id", "employee_rank_code");
				inputIn1.setAttribute("value",commentData.employee_rank_code);
				td1.appendChild(inputIn1);

				var td2 = document.createElement("td");
				td2.innerText = commentData.employee_rank_code;
				trIn1.appendChild(td2);
				
				var td3 = document.createElement("td");
				td3.innerText = commentData.employee_rank_name;
				...
				td5.innerText = moment(commentData.employee_rank_register_date).format('YYYY.MM.DD');
				...
				td7.innerText = moment(commentData.employee_rank_update_date).format('YYYY.MM.DD');
	...
	<div class="container-fluid" id="wrapper">   
	        ...
	        <div class="col form-control mt-3">
	        	<div class="row">
		        	<div class="col-6 mx-0">
		            	 ...
		            	 <button onclick="deleteEmployeeRankInfo()" type="button" class="btn btn-light">
		            		삭제
		            	 </button>
		            </div>
		            <div class="col-6 text-end mx-0 pt-1">
		            	<span class="fs-5">직급 관리</span>
        ...
        <div class="row">
            <div class="form-control mt-3">
                <div class="row">
                    <div class="col">
                    	<i class="bi bi-list fs-5">&nbsp;</i><span class="fs-5">직급 목록</span>
                    </div>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel">직급 등록</h5>
                            ...
                            <div class="row mt-3">
                                <div class="col">
                                    <div class="input-group">
                                        <span class="input-group-text">직급명</span>
                                        <input type="hidden" id="company_code_reg" value="${adminInfo.company_code }">
                                        <input id="employee_rank_name_reg" type="text" class="form-control">
                                    </div>
                                </div>
                            </div>               
                        </div>
                ...
                <div class="modal-footer">
                  ...
                  <button type="button" class="btn btn-primary" onclick="insertEmployeeRankInfo()" data-bs-dismiss="modal">등록</button>
                </div>
              </div>
            </div>
          </div>
                        ...
                        <div class="form-control mt-3">
                            ...
                            <div class="row mt-3">
                                <div class="col">
                                    <div class="input-group">
                                        <span class="input-group-text">직급명</span>
                                        <input type="hidden" id="employee_rank_code_update" value="">
                                        <input type="hidden" id="company_code_update" value="${adminInfo.company_code }">
                                        <input id="employee_rank_name_update" type="text" class="form-control">
                                    </div>
                                </div>
                            </div>
                        </div>
