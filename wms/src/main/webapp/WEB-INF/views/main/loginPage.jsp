	    ...
	    <div class="col">
	      ...
	      <div id="loginBox" class="row">
	        <div class="col" style="text-align: center;">
	          ...
	          <input class="form-control mb-1" type="text" name="employee_email" placeholder="이메일을 입력해주세요.">
	          <input class="form-control mb-1" type="password" name="employee_password" placeholder="비밀번호를 입력해주세요.">
